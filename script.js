...
let songs = [
    {
        ...
        videoBgSrc: "videos/consume.mp4", // Path video background specifically for this song
    ...
    },
    {
        ...
        videoBgSrc: "videos/perfect_bg.mp4", // Path video background specifically for this song
        // Lyrics with timestamp in seconds
        lyrics: [
    ...
    },    
    {
        ...
        videoBgSrc: "videos/unconditionally_bg.mp4", // Path video background specifically for this song
        // Lyrics with timestamp in seconds
        lyrics: [
