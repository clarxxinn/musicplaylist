...
let songs = [
    {
        ...
        lyrics: [
            { time: 0.8, text: "What if I told you that I've fallen?" },
            { time: 4, text: "And I like the way you say my name" },
            { time: 7, text: "My heart skips a beat when I hear you calling" },
            { time: 10, text: "And I like that it won’t go away" },
